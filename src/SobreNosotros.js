           ...
           <Container className="sobreNosotros__container">
            <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                            ...
                            <p className="sobreNosotros__descripcion">Personalizamos tu idea y te damos la posibilidad de contar tu historia, a través de fotografías, frases, recortes, stickers que describirán todo aquello que viviste en esos momentos.
                            </p>
                            <p className="sobreNosotros__descripcion">¡Tomamos tus ideas, personalizamos tu álbum y lo hacemos realidad !.</p>
                    </Grid>
                    <Grid item xs={12} sm={6}>
